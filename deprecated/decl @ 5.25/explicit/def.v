...
| d_typinget_infvar : forall (E:denv) (x:expvar) (T1:dtyp),
    dwf_env E ->
    binds ( x )  ( (dbind_typ T1) ) ( E )  ->
    d_typing_exptapp E (dexp_var_f x) d_typingmode_inf T1
| d_typinget_infanno : forall (E:denv) (e:dexp) (T1:dtyp),
    dwf_typ E T1 ->
...
| d_typinget_infapp : forall (E:denv) (e1 e2:dexp) (T1 T2:dtyp),
...
| d_typinget_inftabs : forall (L:vars) (E:denv) (e:dexp) (T1:dtyp),
...
| d_typinget_chkabstop : forall (L:vars) (E:denv) (e:dexp),
...
| d_typinget_chkabs : forall (L:vars) (E:denv) (e:dexp) (T1 T2:dtyp),
    dwf_typ E T1 ->
...
| d_typinget_chkall : forall (L:vars) (E:denv) (e:dexp) (T1:dtyp),
    dwf_typ E (dtyp_all T1) ->
