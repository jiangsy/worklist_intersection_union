...
Fixpoint size_exp (e1 : exp) {struct e1} : nat :=
  match e1 with
    ...
    | exp_rcd_single l1 e2 => 1 + (size_exp e2)
...
with size_conts (cs1 : conts) {struct cs1} : nat :=
  match cs1 with
    ...
    | conts_infrcdsingle l1 cs2 => 1 + (size_conts cs2)
...
Fixpoint size_work (w1 : work) {struct w1} : nat :=
  match w1 with
    ...
    | work_infrcdsingle l1 A1 cs1 => 1 + (size_typ A1) + (size_conts cs1)
...
Inductive degree_exp_wrt_typ : nat -> exp -> Prop :=
  ...
  | degree_wrt_typ_exp_rcd_single : forall n1 l1 e1,
    degree_exp_wrt_typ n1 e1 ->
    degree_exp_wrt_typ n1 (exp_rcd_single l1 e1)
...
Inductive degree_exp_wrt_exp : nat -> exp -> Prop :=
  ...
  | degree_wrt_exp_exp_rcd_single : forall n1 l1 e1,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 (exp_rcd_single l1 e1)
...
with degree_conts_wrt_typ : nat -> conts -> Prop :=
  ...
  | degree_wrt_typ_conts_infrcdsingle : forall n1 l1 cs1,
    degree_conts_wrt_typ n1 cs1 ->
    degree_conts_wrt_typ n1 (conts_infrcdsingle l1 cs1)
...
with degree_conts_wrt_exp : nat -> conts -> Prop :=
  ...
  | degree_wrt_exp_conts_infrcdsingle : forall n1 l1 cs1,
    degree_conts_wrt_exp n1 cs1 ->
    degree_conts_wrt_exp n1 (conts_infrcdsingle l1 cs1)
...
Inductive degree_work_wrt_typ : nat -> work -> Prop :=
  ...
  | degree_wrt_typ_work_infrcdsingle : forall n1 l1 A1 cs1,
    degree_typ_wrt_typ n1 A1 ->
    degree_conts_wrt_typ n1 cs1 ->
    degree_work_wrt_typ n1 (work_infrcdsingle l1 A1 cs1)
...
Inductive degree_work_wrt_exp : nat -> work -> Prop :=
  ...
  | degree_wrt_exp_work_infrcdsingle : forall n1 l1 A1 cs1,
    degree_conts_wrt_exp n1 cs1 ->
    degree_work_wrt_exp n1 (work_infrcdsingle l1 A1 cs1)
...
Inductive lc_set_exp : exp -> Set :=
  ...
  | lc_set_exp_rcd_single : forall l1 e1,
    lc_set_exp e1 ->
    lc_set_exp (exp_rcd_single l1 e1)
...
with lc_set_conts : conts -> Set :=
  ...
  | lc_set_conts_infrcdsingle : forall l1 cs1,
    lc_set_conts cs1 ->
    lc_set_conts (conts_infrcdsingle l1 cs1)
...
Inductive lc_set_work : work -> Set :=
  ...
  | lc_set_work_infrcdsingle : forall l1 A1 cs1,
    lc_set_typ A1 ->
    lc_set_conts cs1 ->
    lc_set_work (work_infrcdsingle l1 A1 cs1)
