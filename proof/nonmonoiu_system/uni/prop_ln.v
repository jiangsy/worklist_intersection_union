...
Fixpoint size_abind (ab1 : abind) {struct ab1} : nat :=
  match ab1 with
    ...
    | abind_etvar_empty => 1
    | abind_etvar_bound A1 => 1 + (size_typ A1)
  end.
...
Inductive degree_abind_wrt_typ : nat -> abind -> Prop :=
  ...
  | degree_wrt_typ_abind_etvar_bound : forall n1 A1,
    degree_typ_wrt_typ n1 A1 ->
    degree_abind_wrt_typ n1 (abind_etvar_bound A1).
...
Inductive lc_set_abind : abind -> Set :=
  ...
  | lc_set_abind_etvar_bound : forall A1,
    lc_set_typ A1 ->
    lc_set_abind (abind_etvar_bound A1).
