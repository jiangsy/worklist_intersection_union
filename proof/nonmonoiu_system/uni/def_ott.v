...
Definition open_abind_wrt_typ_rec (k:nat) (A5:typ) (ab5:abind) : abind :=
  ...
  | (abind_etvar_bound A) => abind_etvar_bound (open_typ_wrt_typ_rec k A5 A)
end.
...
Definition close_abind_wrt_typ_rec (k:nat) (A5:var) (ab5:abind) : abind :=
  ...
  | abind_etvar_empty => abind_etvar_empty 
  | (abind_etvar_bound A) => abind_etvar_bound (close_typ_wrt_typ_rec k A5 A)
end.
...
Inductive lc_abind : abind -> Prop :=    (* defn lc_abind *)
 ...
 | lc_abind_etvar_bound : forall (A:typ),
     (lc_typ A) ->
     (lc_abind (abind_etvar_bound A)).
...
Definition ftvar_in_abind (ab5:abind) : vars :=
  ...
  | abind_etvar_empty => {}
  | (abind_etvar_bound A) => (ftvar_in_typ A)
end.
...
Definition subst_tvar_in_abind (A5:typ) (X5:typvar) (ab5:abind) : abind :=
  ...
  | abind_etvar_empty => abind_etvar_empty 
  | (abind_etvar_bound A) => abind_etvar_bound (subst_tvar_in_typ A5 X5 A)
end.
...
Inductive a_evs_in_wl : aworklist -> typvar -> typvar -> Prop :=    (* defn a_evs_in_wl *)
 | a_etvars_in_wl__in1 : forall (aW:aworklist) (X2:typvar) (A2:typ) (X1:typvar) (A1:typ),
     lc_typ A2 ->
      binds ( X1 )  ( (abind_etvar_bound A1) ) (  ( awl_to_aenv  aW  )  )  ->
     a_evs_in_wl (aworklist_constvar aW X2 (abind_etvar_bound A2)) X1 X2
 | a_etvars_in_wl__in2 : forall (aW:aworklist) (X2 X1:typvar) (A:typ),
      binds ( X1 )  ( (abind_etvar_bound A) ) (  ( awl_to_aenv  aW  )  )  ->
 ...
 | a_etvars_in_wl__in3 : forall (aW:aworklist) (X2:typvar) (A:typ) (X1:typvar),
     ...
     a_evs_in_wl (aworklist_constvar aW X2 (abind_etvar_bound A)) X1 X2
...
Inductive a_wf_typ : aenv -> typ -> Prop :=    (* defn a_wf_typ *)
 ...
 | a_wf_typ__etvar : forall (aE:aenv) (X:typvar) (A:typ),
      binds ( X )  ( (abind_etvar_bound A) ) ( aE )  ->
     a_wf_typ aE (typ_var_f X)
...
Inductive a_wf_wl : aworklist -> Prop :=    (* defn a_wf_wl *)
 ...
 | a_wf_wl__consetvar : forall (aW:aworklist) (X:typvar) (A:typ),
     ...
     a_wf_wl aW ->
     a_wf_wl (aworklist_constvar aW X (abind_etvar_bound A))
