...
Inductive aworklist_subst : aworklist -> typvar -> typ -> aworklist -> aworklist -> Prop :=
  ...
  | a_ws__var_stay : forall Γ X Y A B Γ1 Γ2,
  ...
  | a_ws__tvar_stay : forall Γ X Y A Γ1 Γ2,
      aworklist_subst Γ X A Γ1 Γ2 ->
      Y <> X ->
...
Inductive a_wl_red : aworklist -> Prop :=    (* defn a_wl_red *)
  ...
  | a_wl_red__sub_label : forall (Γ:aworklist) (l:label),
      a_wl_red Γ ->
      a_wl_red (aworklist_cons_work Γ (work_sub (typ_label l) (typ_label l)))
  ...
  | a_wl_red__sub_etvarmono1 : forall (Γ Γ1 Γ2:aworklist) (X:typvar) (A:typ),
      ...
      (aworklist_subst  Γ  X A Γ1 Γ2) ->
      a_wl_red   (awl_app (subst_tvar_in_aworklist A X Γ2) Γ1 ) ->
  ...
  | a_wl_red__sub_etvarmono2 : forall (Γ Γ1 Γ2:aworklist) (X:typvar) (B:typ),
      ...
      a_wl_red   (awl_app (subst_tvar_in_aworklist B X Γ2) Γ1 ) ->
  ...
  | a_wl_red__inf_proj : forall (Γ:aworklist) (e:exp) (l:label) (cs:conts),
      a_wl_red (aworklist_cons_work Γ (work_infer e (conts_infabs (contd_infproj (typ_label l) cs)))) ->
      a_wl_red (aworklist_cons_work Γ (work_infer  ( (exp_rcd_proj e l) )  cs))
  | a_wl_red__infapp : forall (Γ:aworklist) (A B:typ) (e:exp) (cs:conts),
      a_wl_red (aworklist_cons_work (aworklist_cons_work Γ (work_applys cs B) ) (work_check e A)) ->
      a_wl_red (aworklist_cons_work Γ (work_infapp A B e cs))
  | a_wl_red__infproj: forall (Γ:aworklist) (A B C:typ) (cs:conts),
      a_wl_red (aworklist_cons_work (aworklist_cons_work Γ (work_applys cs B)) (work_sub C A)) ->
      a_wl_red (aworklist_cons_work Γ (work_infproj A B C cs))
  ...
  | a_wl_red__intersectioninfrcdcons : forall (Γ:aworklist) (A1 A2 B:typ) (cs:conts),
      a_wl_red (aworklist_cons_work Γ (work_applys cs (typ_intersection A1 A2))) ->
      a_wl_red (aworklist_cons_work Γ (work_intersectioninfrcdcons A1 A2 cs))
