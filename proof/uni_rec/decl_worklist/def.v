...
Inductive d_wl_del_red : dworklist -> Prop :=
  ...
  | d_wl_del_red__infproj : forall Ω A B C cs,
      d_wl_del_red (dworklist_cons_work (dworklist_cons_work Ω (work_applys cs B)) (work_sub C A)) ->
      d_wl_del_red (dworklist_cons_work Ω (work_infproj A B C cs))
  ...
  | d_wl_del_red__infrcdconsintersection : forall Ω l1 A1 A2 e2 cs,
      ...
      d_wl_del_red (dworklist_cons_work Ω (work_infrcdconsintersection l1 A1 e2 cs))
  | d_wl_del_red__intersectioninfrcdcons : forall Ω A1 A2 cs,
      d_wl_del_red (dworklist_cons_work Ω (work_applys cs (typ_intersection A1 A2))) ->
      d_wl_del_red (dworklist_cons_work Ω (work_intersectioninfrcdcons A1 A2 cs))
...
Inductive d_wl_red : dworklist -> Prop :=    (* defn d_wl_red *)
  ...
  | d_wl_red__sub_label : forall (Ω:dworklist) (l:label),
      d_wl_red Ω ->
      d_wl_red (dworklist_cons_work Ω (work_sub (typ_label l) (typ_label l)))
  | d_wl_red__sub_arrow : forall (Ω:dworklist) (A1 A2 B1 B2:typ),
      d_wl_red (dworklist_cons_work (dworklist_cons_work Ω (work_sub A2 B2)) (work_sub B1 A1)) ->
  ...
  | d_wl_red__inf_proj : forall (Ω:dworklist) (e:exp) (l:label) (cs:conts),
      d_wl_red (dworklist_cons_work Ω (work_infer e (conts_infabs (contd_infproj (typ_label l) cs)))) ->
      d_wl_red (dworklist_cons_work Ω (work_infer  ( (exp_rcd_proj e l) )  cs))
  ...
  | d_wl_red__intersectioninfrcdcons : forall (Ω:dworklist) (A1 A2 B:typ) (cs:conts),
      d_wl_red (dworklist_cons_work Ω (work_applys cs (typ_intersection A1 A2))) ->
      d_wl_red (dworklist_cons_work Ω (work_intersectioninfrcdcons A1 A2 cs))
  ...
  | d_wl_red__infproj: forall (Ω:dworklist) (A B C:typ) (cs:conts),
      d_wl_red (dworklist_cons_work (dworklist_cons_work Ω (work_applys cs B)) (work_sub C A)) ->
      d_wl_red (dworklist_cons_work Ω (work_infproj A B C cs))
