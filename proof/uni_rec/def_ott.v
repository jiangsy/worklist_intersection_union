(* generated by Ott 0.32, locally-nameless lngen from: uni_rec/language.ott *)
Require Import Bool.
...
Fixpoint open_contd_wrt_typ_rec (k:nat) (A5:typ) (cd5:contd) {struct cd5}: contd :=
  ...
  | (contd_infproj A cs) => contd_infproj (open_typ_wrt_typ_rec k A5 A) (open_conts_wrt_typ_rec k A5 cs)
...
Fixpoint open_contd_wrt_exp_rec (k:nat) (e5:exp) (cd5:contd) {struct cd5}: contd :=
  ...
  | (contd_infproj A cs) => contd_infproj A (open_conts_wrt_exp_rec k e5 cs)
...
Fixpoint close_contd_wrt_exp_rec (k:nat) (e5:var) (cd5:contd) {struct cd5}: contd :=
  ...
  | (contd_infproj A cs) => contd_infproj A (close_conts_wrt_exp_rec k e5 cs)
...
Fixpoint close_contd_wrt_typ_rec (k:nat) (A5:var) (cd5:contd) {struct cd5}: contd :=
  ...
  | (contd_infproj A cs) => contd_infproj (close_typ_wrt_typ_rec k A5 A) (close_conts_wrt_typ_rec k A5 cs)
...
Inductive lc_exp : exp -> Prop :=    (* defn lc_exp *)
 ...
 | lc_exp_rcd_cons : forall (l:label) (e1 e2:exp),
     (lc_exp e1) ->
     (lc_exp e2) ->
     (lc_exp (exp_rcd_cons l e1 e2))
 | lc_exp_rcd_proj : forall (e:exp) (l:label),
     (lc_exp e) ->
     (lc_exp (exp_rcd_proj e l)).
...
Inductive lc_contd : contd -> Prop :=    (* defn lc_contd *)
 ...
 | lc_contd_infproj : forall (A:typ) (cs:conts),
     (lc_typ A) ->
     (lc_conts cs) ->
     (lc_contd (contd_infproj A cs))
...
with lc_conts : conts -> Prop :=    (* defn lc_conts *)
 ...
 | lc_conts_infrcdconsintersection : forall (l:label) (e:exp) (cs:conts),
     (lc_exp e) ->
     (lc_conts cs) ->
     (lc_conts (conts_infrcdconsintersection l e cs))
 | lc_conts_intersectioninfrcdcons : forall (A:typ) (cs:conts),
     (lc_typ A) ->
     (lc_conts cs) ->
     (lc_conts (conts_intersectioninfrcdcons A cs))
...
Inductive lc_work : work -> Prop :=    (* defn lc_work *)
 ...
 | lc_work_infproj : forall (A B C:typ) (cs:conts),
     (lc_typ A) ->
     (lc_typ B) ->
     (lc_typ C) ->
     (lc_conts cs) ->
 ...
 | lc_work_infrcdconsintersection : forall (l:label) (A:typ) (e:exp) (cs:conts),
     ...
     (lc_exp e) ->
     (lc_conts cs) ->
     (lc_work (work_infrcdconsintersection l A e cs))
 | lc_work_intersectioninfrcdcons : forall (A1 A2:typ) (cs:conts),
     (lc_typ A1) ->
     (lc_typ A2) ->
     (lc_conts cs) ->
     (lc_work (work_intersectioninfrcdcons A1 A2 cs))
...
Fixpoint ftvar_in_contd (cd5:contd) : vars :=
  ...
  | (contd_infproj A cs) => (ftvar_in_typ A) \u (ftvar_in_conts cs)
...
Fixpoint fvar_in_contd (cd5:contd) : vars :=
  ...
  | (contd_infproj A cs) => (fvar_in_conts cs)
...
Fixpoint subst_tvar_in_exp (A_5:typ) (X5:typvar) (e_5:exp) {struct e_5} : exp :=
  ...
  | exp_rcd_nil => exp_rcd_nil 
  | (exp_rcd_cons l e1 e2) => exp_rcd_cons l (subst_tvar_in_exp A_5 X5 e1) (subst_tvar_in_exp A_5 X5 e2)
  | (exp_rcd_proj e l) => exp_rcd_proj (subst_tvar_in_exp A_5 X5 e) l
end.
...
Fixpoint subst_var_in_exp (e_5:exp) (x5:expvar) (e__6:exp) {struct e__6} : exp :=
  ...
  | exp_rcd_nil => exp_rcd_nil 
  | (exp_rcd_cons l e1 e2) => exp_rcd_cons l (subst_var_in_exp e_5 x5 e1) (subst_var_in_exp e_5 x5 e2)
  | (exp_rcd_proj e l) => exp_rcd_proj (subst_var_in_exp e_5 x5 e) l
end.
...
Fixpoint subst_tvar_in_contd (A5:typ) (X5:typvar) (cd5:contd) {struct cd5} : contd :=
  ...
  | (contd_infproj A cs) => contd_infproj (subst_tvar_in_typ A5 X5 A) (subst_tvar_in_conts A5 X5 cs)
...
with subst_tvar_in_conts (A_5:typ) (X5:typvar) (cs5:conts) {struct cs5} : conts :=
  ...
  | (conts_infrcdconsintersection l e cs) => conts_infrcdconsintersection l (subst_tvar_in_exp A_5 X5 e) (subst_tvar_in_conts A_5 X5 cs)
  | (conts_intersectioninfrcdcons A cs) => conts_intersectioninfrcdcons (subst_tvar_in_typ A_5 X5 A) (subst_tvar_in_conts A_5 X5 cs)
...
Fixpoint subst_var_in_contd (e5:exp) (x5:expvar) (cd5:contd) {struct cd5} : contd :=
  ...
  | (contd_infproj A cs) => contd_infproj A (subst_var_in_conts e5 x5 cs)
...
with subst_var_in_conts (e5:exp) (x5:expvar) (cs5:conts) {struct cs5} : conts :=
  ...
  | (conts_infrcdconsintersection l e cs) => conts_infrcdconsintersection l (subst_var_in_exp e5 x5 e) (subst_var_in_conts e5 x5 cs)
  | (conts_intersectioninfrcdcons A cs) => conts_intersectioninfrcdcons A (subst_var_in_conts e5 x5 cs)
  | (conts_sub A) => conts_sub A
end.
...
Definition subst_tvar_in_work (A_5:typ) (X5:typvar) (w5:work) : work :=
  ...
  | (work_infproj A B C cs) => work_infproj (subst_tvar_in_typ A_5 X5 A) (subst_tvar_in_typ A_5 X5 B) (subst_tvar_in_typ A_5 X5 C) (subst_tvar_in_conts A_5 X5 cs)
  | (work_infrcdconsintersection l A e cs) => work_infrcdconsintersection l (subst_tvar_in_typ A_5 X5 A) (subst_tvar_in_exp A_5 X5 e) (subst_tvar_in_conts A_5 X5 cs)
  | (work_intersectioninfrcdcons A1 A2 cs) => work_intersectioninfrcdcons (subst_tvar_in_typ A_5 X5 A1) (subst_tvar_in_typ A_5 X5 A2) (subst_tvar_in_conts A_5 X5 cs)
...
Definition subst_var_in_work (e5:exp) (x5:expvar) (w5:work) : work :=
  ...
  | (work_infproj A B C cs) => work_infproj A B C (subst_var_in_conts e5 x5 cs)
  | (work_infrcdconsintersection l A e cs) => work_infrcdconsintersection l A (subst_var_in_exp e5 x5 e) (subst_var_in_conts e5 x5 cs)
  | (work_intersectioninfrcdcons A1 A2 cs) => work_intersectioninfrcdcons A1 A2 (subst_var_in_conts e5 x5 cs)
...
Inductive d_wf_conts : denv -> conts -> Prop :=    (* defn d_wf_conts *)
 ...
 | d_wf_conts__infrcdconsintersection : forall (Ψ:denv) (l:label) (e:exp) (cs:conts),
     d_wf_exp Ψ e ->
     d_wf_conts Ψ cs ->
     d_wf_conts Ψ (conts_infrcdconsintersection l e cs)
 | d_wf_conts__intersectioninfrcdcons : forall (Ψ:denv) (A:typ) (cs:conts),
     d_wf_typ Ψ A ->
     d_wf_conts Ψ cs ->
     d_wf_conts Ψ (conts_intersectioninfrcdcons A cs)
...
with d_wf_contd : denv -> contd -> Prop :=    (* defn d_wf_contd *)
 ...
 | d_wf_contd__infproj : forall (Ψ:denv) (A:typ) (cs:conts),
     d_wf_typ Ψ A ->
     d_wf_conts Ψ cs ->
     d_wf_contd Ψ (contd_infproj A cs).
...
Inductive d_wf_work : denv -> work -> Prop :=    (* defn d_wf_work *)
 ...
 | d_wf_work__infproj : forall (Ψ:denv) (A B C:typ) (cs:conts),
     d_wf_typ Ψ (typ_arrow A B) ->
     d_wf_typ Ψ C ->
     d_wf_conts Ψ cs ->
 ...
 | d_wf_work__infrcdconsintersection : forall (Ψ:denv) (l:label) (A:typ) (e:exp) (cs:conts),
     ...
     d_wf_exp Ψ e ->
     d_wf_conts Ψ cs ->
     d_wf_work Ψ (work_infrcdconsintersection l A e cs)
 | d_wf_work__intersectioninfrcdcons : forall (Ψ:denv) (A1 A2:typ) (cs:conts),
     d_wf_typ Ψ A1 ->
     d_wf_typ Ψ A2 ->
     d_wf_conts Ψ cs ->
     d_wf_work Ψ (work_intersectioninfrcdcons A1 A2 cs)
...
Inductive a_wf_conts : aenv -> conts -> Prop :=    (* defn a_wf_conts *)
 ...
 | a_wf_conts__infrcdconsintersection : forall (Σ:aenv) (l:label) (e:exp) (cs:conts),
     a_wf_exp Σ e ->
     a_wf_conts Σ cs ->
     a_wf_conts Σ (conts_infrcdconsintersection l e cs)
 | a_wf_conts__intersectioninfrcdcons : forall (Σ:aenv) (A:typ) (cs:conts),
     a_wf_typ Σ A ->
     a_wf_conts Σ cs ->
     a_wf_conts Σ (conts_intersectioninfrcdcons A cs)
...
with a_wf_contd : aenv -> contd -> Prop :=    (* defn a_wf_contd *)
 ...
 | a_wf_contd__infproj : forall (Σ:aenv) (A:typ) (cs:conts),
     a_wf_typ Σ A ->
     a_wf_conts Σ cs ->
     a_wf_contd Σ (contd_infproj A cs).
...
Inductive a_wf_work : aenv -> work -> Prop :=    (* defn a_wf_work *)
 ...
 | a_wf_work__infproj : forall (Σ:aenv) (A B C:typ) (cs:conts),
     a_wf_typ Σ (typ_arrow A B) ->
     a_wf_typ Σ C ->
     a_wf_conts Σ cs ->
 ...
 | a_wf_work__infrcdconsintersection : forall (Σ:aenv) (l:label) (A:typ) (e:exp) (cs:conts),
     ...
     a_wf_exp Σ e ->
     a_wf_conts Σ cs ->
     a_wf_work Σ (work_infrcdconsintersection l A e cs)
 | a_wf_work__intersectioninfrcdcons : forall (Σ:aenv) (A1 A2:typ) (cs:conts),
     a_wf_typ Σ A1 ->
     a_wf_typ Σ A2 ->
     a_wf_conts Σ cs ->
     a_wf_work Σ (work_intersectioninfrcdcons A1 A2 cs)
...
(** infrastructure *)
#[export] Hint Constructors is_exp_rcd s_in neq_abs neq_all neq_intersection neq_union d_wf_typ d_wf_exp d_wf_tenv d_wf_env d_mono_typ d_wf_conts d_wf_contd d_wf_work d_wf_twl d_wf_wl d_sub a_wf_typ a_mono_typ a_wf_exp a_wf_conts a_wf_contd a_wf_work a_wf_wwl a_wf_twl a_wf_wl a_wf_env lc_typ lc_exp lc_contd lc_conts lc_dbind lc_abind lc_work lc_aworklist lc_dworklist : core.
