...
(* defns typ_bot_like *)
Inductive typ_bot_like : typ -> Prop :=    (* defn typ_bot_like *)
 | typ_bl__bot : 
     typ_bot_like typ_bot
 | typ_bl__intersection1 : forall (A B:typ),
     lc_typ B ->
     typ_bot_like A ->
     typ_bot_like (typ_intersection A B)
 | typ_bl__intersection2 : forall (A B:typ),
     lc_typ A ->
     typ_bot_like B ->
     typ_bot_like (typ_intersection A B)
 ...
 | typ_bl__all : forall (L:vars) (A:typ),
      ( forall X , X \notin  L  -> typ_bot_like  ( open_typ_wrt_typ A (typ_var_f X) )  )  ->
...
(* defns J_d_strong_neq_stvar *)
Inductive d_sneq_stvar : denv -> typ -> Prop :=    (* defn d_sneq_stvar *)
 | d_sneq_stvar__unit : forall (Ψ:denv),
     d_sneq_stvar Ψ typ_unit
 | d_sneq_stvar__top : forall (Ψ:denv),
     d_sneq_stvar Ψ typ_top
 | d_sneq_stvar__bot : forall (Ψ:denv),
     d_sneq_stvar Ψ typ_bot
 | d_sneq_stvar__tvar : forall (Ψ:denv) (X:typvar),
      binds ( X )  ( dbind_tvar_empty ) ( Ψ )  ->
     d_sneq_stvar Ψ (typ_var_f X)
 | d_sneq_stvar__arrow : forall (Ψ:denv) (A1 A2:typ),
     lc_typ A1 ->
     lc_typ A2 ->
     d_sneq_stvar Ψ (typ_arrow A1 A2)
 | d_sneq_stvar__all : forall (Ψ:denv) (A:typ),
     lc_typ (typ_all A) ->
     d_sneq_stvar Ψ (typ_all A)
 | d_sneq_stvar__union : forall (Ψ:denv) (A1 A2:typ),
     d_sneq_stvar Ψ A1 ->
     d_sneq_stvar Ψ A2 ->
     d_sneq_stvar Ψ (typ_union A1 A2)
 | d_sneq_stvar__intersection : forall (Ψ:denv) (A1 A2:typ),
     d_sneq_stvar Ψ A1 ->
     d_sneq_stvar Ψ A2 ->
     d_sneq_stvar Ψ (typ_intersection A1 A2).
...
Inductive d_sub : denv -> typ -> typ -> Prop :=    (* defn d_sub *)
 ...
 | d_sub__all : forall (L:vars) (Ψ:denv) (A B:typ),
      ( forall X , X \notin  L  ->  (  (  ( d_sneq_stvar  ( X ~ dbind_tvar_empty  ++  Ψ )   ( open_typ_wrt_typ A (typ_var_f X) )  ) /\ ( d_sneq_stvar  ( X ~ dbind_tvar_empty  ++  Ψ )   ( open_typ_wrt_typ B (typ_var_f X) )  )  )  ) \/ ( typ_bot_like (typ_all A) )  )  ->
 ...
 | d_sub__alll : forall (L:vars) (Ψ:denv) (A B T:typ),
     ...
     neq_intersection B ->
     neq_union B ->
      ( forall X , X \notin  L  ->  ( d_sneq_stvar  ( X ~ dbind_tvar_empty  ++  Ψ )   ( open_typ_wrt_typ A (typ_var_f X) )  ) \/ ( typ_bot_like (typ_all A) )  )  ->
     d_mono_typ Ψ T ->
 ...
 | d_sub__all_refl : forall (L:vars) (Ψ:denv) (A1:typ),
      ( forall X , X \notin  L  -> d_sub  ( X ~ dbind_stvar_empty  ++  Ψ )   ( open_typ_wrt_typ A1 (typ_var_f X) )   ( open_typ_wrt_typ A1 (typ_var_f X) )  )  ->
...
(** infrastructure *)
#[export] Hint Constructors s_in s_in_b neq_abs neq_all neq_intersection neq_union neq_bot d_wf_typ d_wf_exp d_wf_body d_wf_tenv d_wf_env d_mono_typ d_wf_conts d_wf_contd d_wf_work typ_bot_like d_wf_twl d_wf_wl d_sneq_stvar d_sub a_wf_typ a_mono_typ a_wf_exp a_wf_body a_wf_conts a_wf_contd a_wf_work a_wf_wwl a_wf_twl a_wf_wl a_wf_env lc_typ lc_exp lc_body lc_contd lc_conts lc_abind lc_dbind lc_work lc_aworklist lc_dworklist : core.
