...
Theorem dsub_unit_all_false: forall Ψ A,
  Ψ ᵗ⊢ᵈ typ_all A ->
...
Theorem dsub_top_all_false: forall Ψ A,
  Ψ ᵗ⊢ᵈ typ_all A ->
  Ψ ⊢ typ_top <: typ_all A ->
  False.
Proof.
...
Theorem dsub_top_fv_false: forall Ψ X A,
  s_in X A ->
  Ψ ⊢ typ_top <: A ->
  False.
Proof.
...
Theorem dsub_unit_fv_false: forall Ψ X A,
  s_in X A ->
  Ψ ⊢ typ_unit <: A ->
  False.
Proof.
