...
Inductive a_wl_red : aworklist -> Prop :=    (* defn a_wl_red *)
 ...
 | a_wlred__sub_alll : forall (L:vars) (Γ:aworklist) (B1 A1:typ),
     neq_all A1 ->
     neq_intersection A1 ->
     neq_union A1 ->
 ...
 | a_wlred__sub_all : forall (L:vars) (Γ:aworklist) (B1 A1:typ),
 ...
 | a_wlred__sub_arrow1 : forall (L:vars) (Γ:aworklist) (X:typvar) (A1 A2 B1 B2:typ) (X1 X2:typvar),
 ...
 | a_wlred__sub_arrow2 : forall (L:vars) (Γ:aworklist) (A1 A2:typ) (X:typvar) (B1 B2:typ) (X1 X2:typvar),
      binds ( X )  ( (abind_bound B1 B2) ) (  ( awl_to_aenv  Γ  )  )  ->
      ( a_smono_typ   ( awl_to_aenv  Γ  )     ( (typ_arrow A1 A2) )   -> False )  ->
      (  forall X1 X2 Γ2 Γ3, X1 `notin` L -> X2 `notin` (L `union` singleton X1) -> 
 ...
 | a_wlred__sub_etvar1 : forall (L:vars) (Γ:aworklist) (Y X:typvar) (B1 B2 B3 B4:typ),
      binds ( X )  ( (abind_bound B1 B2) ) (  ( awl_to_aenv  Γ  )  )  ->
 ...
 | a_wlred__sub_etvar2 : forall (L:vars) (Γ:aworklist) (X Y:typvar) (B1 B2 B3 B4:typ),
      binds ( X )  ( (abind_bound B1 B2) ) (  ( awl_to_aenv  Γ  )  )  ->
 ...
 | a_wlred__sub_etvarmono1 : forall (L:vars) (Γ:aworklist) (A1:typ) (X:typvar) (B1 B2:typ),
      binds ( X )  ( (abind_bound B1 B2) ) (  ( awl_to_aenv  Γ  )  )  ->
 ...
 | a_wlred__sub_etvarmono2 : forall (L:vars) (Γ:aworklist) (X:typvar) (B1 A1 A2:typ),
 ...
 | a_wlred__sub_intersection1 : forall (Γ:aworklist) (A1 B1 B2:typ),
 ...
 | a_wlred__sub_intersection2 : forall (Γ:aworklist) (B1 B2 A1:typ),
     a_wl_red (aworklist_conswork Γ (work_sub B1 A1)) ->
     a_wl_red (aworklist_conswork Γ (work_sub (typ_intersection B1 B2) A1))
 | a_wlred__sub_intersection3 : forall (Γ:aworklist) (B1 B2 A1:typ),
     a_wl_red (aworklist_conswork Γ (work_sub B2 A1)) ->
     a_wl_red (aworklist_conswork Γ (work_sub (typ_intersection B1 B2) A1))
 | a_wlred__sub_union1 : forall (Γ:aworklist) (B1 A1 A2:typ),
     a_wl_red (aworklist_conswork Γ (work_sub B1 A1)) ->
     a_wl_red (aworklist_conswork Γ (work_sub B1 (typ_union A1 A2)))
 | a_wlred__sub_union2 : forall (Γ:aworklist) (B1 A1 A2:typ),
     a_wl_red (aworklist_conswork Γ (work_sub B1 A2)) ->
     a_wl_red (aworklist_conswork Γ (work_sub B1 (typ_union A1 A2)))
 | a_wlred__sub_union3 : forall (Γ:aworklist) (B1 B2 A1:typ),
 ...
 | a_wlred__chk_sub : forall (Γ:aworklist) (e:exp) (A1:typ),
     a_wl_red (aworklist_conswork Γ (work_infer e (cont_sub A1))) ->
     a_wl_red (aworklist_conswork Γ (work_check e A1))
 | a_wlred__chk_absarrow : forall (L:vars) (Γ:aworklist) (e:exp) (A1 A2:typ),
 ...
 | a_wlred__chk_absevar : forall (L:vars) (Γ:aworklist) (e:exp) (X:typvar) (A1 A2:typ) (X1 X2:typvar),
      binds ( X )  ( (abind_bound A1 A2) ) (  ( awl_to_aenv  Γ  )  )  ->
 ...
 | a_wlred__chk_abstop : forall (L:vars) (Γ:aworklist) (e:exp),
 ...
 | a_wlred__chk_inter : forall (Γ:aworklist) (e:exp) (A1 A2:typ),
 ...
 | a_wlred__chk_union1 : forall (Γ:aworklist) (e:exp) (A1 A2:typ),
     a_wl_red (aworklist_conswork Γ (work_check e A1)) ->
     a_wl_red (aworklist_conswork Γ (work_check e (typ_union A1 A2)))
 | a_wlred__chk_union2 : forall (Γ:aworklist) (e:exp) (A1 A2:typ),
     a_wl_red (aworklist_conswork Γ (work_check e A2)) ->
     a_wl_red (aworklist_conswork Γ (work_check e (typ_union A1 A2)))
 | a_wlred__inf_var : forall (Γ:aworklist) (x:expvar) (c:cont) (A:typ),
 ...
 | a_wlred__inf_anno : forall (Γ:aworklist) (e:exp) (A:typ) (c:cont),
 ...
 | a_wlred__inf_tabs : forall (L:vars) (Γ:aworklist) (e:exp) (A:typ) (c:cont) (Γ2:aworklist),
     lc_aworklist Γ ->
 ...
 | a_wlred__inf_unit : forall (Γ:aworklist) (c:cont),
 ...
 | a_wlred__infabs_inter2 : forall (Γ:aworklist) (A1 A2:typ) (c:cont),
     lc_typ A1 ->
     a_wl_red (aworklist_conswork Γ (work_infabs A2 c)) ->
     a_wl_red (aworklist_conswork Γ (work_infabs (typ_intersection A1 A2) c))
 | a_wlred__infabs_union : forall (Γ:aworklist) (A1 A2:typ) (c:cont),
 ...
 | a_wlred__infabsunion : forall (Γ:aworklist) (B1 C1 A2:typ) (c:cont),
 ...
 | a_wlred__inftappunion : forall (Γ:aworklist) (C1 A2 B:typ) (c:cont),
