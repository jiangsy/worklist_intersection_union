...
| d_inftapp__bot : forall (E:denv) (T1:typ),
    d_wf_env E -> 
    d_wf_typ E T1 ->
    d_inftapp E typ_bot T1 typ_bot
| d_inftapp__all : forall (E:denv) (T1 T2:typ),
    d_wf_env E -> 
    d_wf_typ E (typ_all T1) ->
    d_wf_typ E T2 ->
    d_inftapp E (typ_all T1) T2 (open_typ_wrt_typ  T1   T2 )
| d_inftapp__intersection1 : forall (E:denv) (A1 A2 B C1:typ),
    d_wf_typ E A2 ->
    d_inftapp E A1 B C1 ->
    d_inftapp E (typ_intersection A1 A2) B C1
| d_inftapp__intersection2 : forall (E:denv) (A1 A2 B C2:typ),
    d_wf_typ E A1 ->
    d_inftapp E A2 B C2 ->
    d_inftapp E (typ_intersection A1 A2) B C2
| d_typing__union : forall (E:denv) (A1 A2 B C1 C2:typ),
    d_inftapp E A1 B C1 ->
    d_inftapp E A2 B C2 ->
...
| d_infabs__bot : forall (E:denv),
    d_wf_env E ->
    d_infabs E typ_bot typ_top typ_bot
| d_infabs__arr : forall (E:denv) (T1 T2:typ),
    d_wf_env E ->
    d_wf_typ E T1 ->
    d_wf_typ E T2 ->
    d_infabs E (typ_arrow T1 T2) T1 T2
| d_infabs__all : forall (E:denv) (T1 T2 T3 T4:typ),
    d_mono_typ E T2 -> 
    d_wf_typ E T2 ->
    d_wf_typ E (typ_all T1) ->
    d_infabs E  (open_typ_wrt_typ  T1   T2 ) T3 T4 ->
    d_infabs E (typ_all T1) T3 T4
| d_infabs__intersection1 : forall (E:denv) (T1 T2 T3 T4:typ),
    d_wf_typ E T2 ->
    d_infabs E T1 T3 T4->
    d_infabs E (typ_intersection T1 T2) T3 T4
| d_infabs__intersection2 : forall (E:denv) (T1 T2 T3 T4:typ),
    d_wf_typ E T1 ->
    d_infabs E T2 T3 T4->
    d_infabs E (typ_intersection T1 T2) T3 T4
| d_infabs__union : forall (E:denv) (T1 T2 T3 T4 T5 T6:typ),
    d_infabs E T1 T3 T4->
    d_infabs E T2 T5 T6->
...
| d_typing__infvar : forall (E:denv) (x:expvar) (T1:typ),
    d_wf_env E ->
    binds ( x )  ( (dbind_typ T1) ) ( E )  ->
    d_typing E (exp_var_f x) typingmode__inf T1
| d_typing__infanno : forall (E:denv) (e:exp) (T1:typ),
    d_wf_typ E T1 ->
...
| d_typing__inftapp : forall (E:denv) (e1:exp) (T1 T2 T3:typ),
    d_wf_typ E T2 ->
    d_typing E e1 typingmode__inf T1 ->
    d_inftapp E T1 T2 T3 ->
    d_typing E (exp_tapp e1 T2) typingmode__inf T3
| d_typing__chkabstop : forall (L:vars) (E:denv) (e:exp),
...
| d_typing__chkabs : forall (L:vars) (E:denv) (e:exp) (T1 T2:typ),
    d_wf_typ E T1 ->
...
(* | d_typing__chkall : forall (L:vars) (E:denv) (e:exp) (T1:typ),
    d_wf_typ E (typ_all T1) ->
...
| d_typing__chksub : forall (E:denv) (e:exp) (T1 S1:typ),
    d_typing E e typingmode__inf S1 ->
    d_sub E S1 T1 ->
    d_typing E e typingmode__chk T1
| d_typing__chkintersection : forall (E:denv) (e:exp) (S1 T1:typ),
    d_typing E e typingmode__chk S1 ->
    d_typing E e typingmode__chk T1 ->
    d_typing E e typingmode__chk (typ_intersection S1 T1)
| d_typing__chkunion1 : forall (E:denv) (e:exp) (S1 T1:typ),
    d_typing E e typingmode__chk S1 ->
    d_wf_typ E T1 ->
    d_typing E e typingmode__chk (typ_union S1 T1)
| d_typing__chkunion2 : forall (E:denv) (e:exp) (S1 T1:typ),
    d_typing E e typingmode__chk T1 ->
    d_wf_typ E S1 ->
    d_typing E e typingmode__chk (typ_union S1 T1)
.
