...
Inductive d_wl_red : dworklist -> Prop :=    (* defn d_wl_red *)
 ...
 | d_wl_red__stvar : forall (Ω:dworklist) (SX:atom),
    d_wl_red Ω ->
    d_wl_red (dworklist_constvar Ω SX dbind_stvar_empty)
 | d_wl_red__subtop : forall (Ω:dworklist) (A1:typ),
     d_wl_red Ω ->
     d_wl_red (dworklist_conswork Ω (work_sub A1 typ_top))
 | d_wl_red__sub_bot : forall (Ω:dworklist) (A1:typ),
     d_wl_red Ω ->
 ...
 | d_wl_red__sub_all : forall (L:vars) (Ω:dworklist) (A1 B1:typ),
 ...
 | d_wl_red__sub_alll : forall (Ω:dworklist) (A1 B1 T1:typ),
     neq_all B1 ->
     neq_intersection B1 ->
     neq_union B1 -> 
 ...
 | d_wl_red__sub_intersection1 : forall (Ω:dworklist) (A1 B1 B2:typ),
 ...
 | d_wl_red__sub_intersection2 : forall (Ω:dworklist) (A1 A2 B1:typ),
     d_wl_red (dworklist_conswork Ω (work_sub A1 B1)) ->
     d_wl_red (dworklist_conswork Ω (work_sub (typ_intersection A1 A2) B1))
 | d_wl_red__sub_intersection3 : forall (Ω:dworklist) (A1 A2 B1:typ),
     d_wl_red (dworklist_conswork Ω (work_sub A2 B1)) ->
     d_wl_red (dworklist_conswork Ω (work_sub (typ_intersection A1 A2) B1))
 | d_wl_red__sub_union1 : forall (Ω:dworklist) (A1 B1 B2:typ),
     d_wl_red (dworklist_conswork Ω (work_sub A1 B1)) ->
     d_wl_red (dworklist_conswork Ω (work_sub A1 (typ_union B1 B2)))
 | d_wl_red__sub_union2 : forall (Ω:dworklist) (A1 B1 B2:typ),
 ...
 | d_wl_red__chk_sub : forall (Ω:dworklist) (e:exp) (A1:typ),
 ...
 | d_wl_red__chk_union2 : forall (Ω:dworklist) (e:exp) (A1 A2:typ),
     ...
     d_wl_red (dworklist_conswork Ω (work_check e (typ_union A1 A2)))
 | d_wl_red__inf_var : forall (Ω:dworklist) (x:expvar) (c:cont) (A1:typ),
 ...
 | d_wl_red__inf_anno : forall (Ω:dworklist) (e:exp) (A1:typ) (c:cont),
 ...
 | d_wl_red__inf_tabs : forall (L:vars) (Ω:dworklist) (e:exp) (A1:typ) (c:cont),
 ...
 | d_wl_red__inftappunion : forall (Ω:dworklist) (A2 B2 C1:typ) (c:cont),
 ...
 | d_wl_red__infabs_arrow : forall (Ω:dworklist) (T1 T2:typ) (c:cont),
 ...
 | d_wl_red__infabs_all : forall (Ω:dworklist) (A1 T1:typ) (c:cont),
     d_mono_typ (dwl_to_denv Ω) T1 ->
 ...
 | d_wl_red__infabsunion: forall (Ω:dworklist) (A2 B1 C1:typ) (c:cont),
 ...
 | d_wl_red__infapp: forall (Ω:dworklist) (e:exp) (A1 B1:typ) (c:cont),
 ...
 | d_wl_red__applycont : forall (Ω:dworklist) (w:work) (T1:typ) (c:cont),
     apply_cont c T1 w ->
