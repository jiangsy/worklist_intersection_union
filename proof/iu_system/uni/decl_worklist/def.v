...
Inductive d_wl_del_red : dworklist -> Prop :=
  ...
  | d_wldelred__infabs : forall Γ T1 T2 T3 c,
  ...
  | d_wldelred__infabsunion : forall Γ A2 B1 B2 C1 C2 c,
  ...
  | d_wldelred__inftapp : forall Γ T1 T2 T3 c,
  ...
  | d_wldelred__inftappunion : forall Γ A2 B2 C1 C2 c,
  ...
  | d_wldelred_unioninftapp : forall Γ A1 A2 c,
...
Inductive d_wl_red : dworklist -> Prop :=    (* defn d_wl_red *)
 ...
 | d_wlred__sub_all : forall (L:vars) (Γ:dworklist) (A1 B1:typ),
 ...
 | d_wlred__sub_alll : forall (Γ:dworklist) (A1 B1 T1:typ),
     neq_all B1 ->
     neq_intersection B1 ->
     neq_union B1 -> 
 ...
 | d_wlred__sub_intersection1 : forall (Γ:dworklist) (A1 B1 B2:typ),
 ...
 | d_wlred__sub_intersection2 : forall (Γ:dworklist) (A1 A2 B1:typ),
     d_wl_red (dworklist_conswork Γ (work_sub A1 B1)) ->
     d_wl_red (dworklist_conswork Γ (work_sub (typ_intersection A1 A2) B1))
 | d_wlred__sub_intersection3 : forall (Γ:dworklist) (A1 A2 B1:typ),
     d_wl_red (dworklist_conswork Γ (work_sub A2 B1)) ->
     d_wl_red (dworklist_conswork Γ (work_sub (typ_intersection A1 A2) B1))
 | d_wlred__sub_union1 : forall (Γ:dworklist) (A1 B1 B2:typ),
     d_wl_red (dworklist_conswork Γ (work_sub A1 B1)) ->
     d_wl_red (dworklist_conswork Γ (work_sub A1 (typ_union B1 B2)))
 | d_wlred__sub_union2 : forall (Γ:dworklist) (A1 B1 B2:typ),
     d_wl_red (dworklist_conswork Γ (work_sub A1 B2)) ->
     d_wl_red (dworklist_conswork Γ (work_sub A1 (typ_union B1 B2)))
 | d_wlred__sub_union3 : forall (Γ:dworklist) (A1 A2 B1:typ),
 ...
 | d_wlred__chk_sub : forall (Γ:dworklist) (e:exp) (A1:typ),
     neq_intersection A1 ->
     neq_union A1 ->
     d_wl_red (dworklist_conswork Γ (work_infer e (cont_sub A1))) ->
     d_wl_red (dworklist_conswork Γ (work_check e A1))
 (* | d_wlred__chkall : forall (L:vars) (Γ:dworklist) (e:exp) (T1:typ),
 ...
 | d_wlred__chk_absarrow : forall (L:vars) (Γ:dworklist) (e:exp) (A1 A2:typ),
 ...
 | d_wlred__chk_abstop : forall (L:vars) (Γ:dworklist) (e:exp),
 ...
 | d_wlred__chk_inter : forall (Γ:dworklist) (e:exp) (A1 A2:typ),
 ...
 | d_wlred__chk_union1 : forall (Γ:dworklist) (e:exp) (A1 A2:typ),
     d_wl_red (dworklist_conswork Γ (work_check e A1)) ->
     d_wl_red (dworklist_conswork Γ (work_check e (typ_union A1 A2)))
 | d_wlred__chk_union2 : forall (Γ:dworklist) (e:exp) (A1 A2:typ),
     d_wl_red (dworklist_conswork Γ (work_check e A2)) ->
     d_wl_red (dworklist_conswork Γ (work_check e (typ_union A1 A2)))
 | d_wlred__inf_var : forall (Γ:dworklist) (x:expvar) (c:cont) (A1:typ),
 ...
 | d_wlred__inf_anno : forall (Γ:dworklist) (e:exp) (A1:typ) (c:cont),
 ...
 | d_wlred__inf_tabs : forall (L:vars) (Γ:dworklist) (e:exp) (A1:typ) (c:cont),
 ...
 | d_wlred__inftappunion : forall (Γ:dworklist) (A2 B2 C1:typ) (c:cont),
 ...
 | d_wlred__unioninfabs: forall (Γ:dworklist) (A1 A2 B1 B2:typ) (c:cont),
 ...
 | d_wlred__infabsunion: forall (Γ:dworklist) (A2 B1 C1:typ) (c:cont),
 ...
 | d_wlred__infapp: forall (Γ:dworklist) (e:exp) (A1 B1:typ) (c:cont),
 ...
 | d_wlred__applycont : forall (Γ Γ':dworklist) (T1:typ) (c:cont),
     d_apply_cont c T1 Γ' ->
