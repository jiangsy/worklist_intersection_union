...
Inductive d_maybetyp : Prop :=
  | none : d_maybetyp
  | some (T:dtyp) : d_maybetyp. 

(* TODO : check *)
Inductive apply_dcont : dcont -> d_maybetyp -> dworklist -> Prop :=
  (* | applydcont_done : forall T1,  
      apply_dcont dcont_done (some T1) dworklist_empty *)
  | applydcont_infabs: forall T1 c,
      apply_dcont (dcont_infabs c) (some T1) (dworklist_conswork dworklist_empty (dwork_infabs T1 c))
  (* | applydcont_infapp : forall T1 T2 e c,
      apply_dcont (dcont_infapp e c) (dtyp_arrow T1 T2) (dworklist_conswork (dworklist_conswork dworklist_empty 
                                                                            (dwork_apply c T2)) 
                                                                            (dwork_check e T1)) *)
  | applydcont_tapp : forall T1 T2 c,
      apply_dcont (dcont_tapp T2 c) (some T1) (dworklist_conswork dworklist_empty (dwork_inftapp T1 T2 c))
  | applydcont_sub : forall T1 S1,
      apply_dcont (dcont_sub S1) (some T1) (dworklist_conswork dworklist_empty (dwork_sub T1 S1))
.
...
Inductive dwl_del_red : dworklist -> Prop :=
  ...
  | dwldelred_infabs : forall Γ T1 T2 T3 c,
      ...
      dwl_del_red (dworklist_conswork Γ (dwork_apply c (dtyp_arrow T2 T3))) ->
  ...
  | dwldelred_inftapp : forall Γ T1 T2 T3 c,
      ...
      dwl_del_red (dworklist_conswork Γ (dwork_apply c T3)) -> 
