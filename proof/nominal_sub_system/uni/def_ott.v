...
Fixpoint open_cont_wrt_typ_rec (k:nat) (A5:typ) (c5:cont) {struct c5}: cont :=
  match c5 with
  | (cont_infabs c) => cont_infabs (open_cont_wrt_typ_rec k A5 c)
  | (cont_infapp e c) => cont_infapp (open_exp_wrt_typ_rec k A5 e) (open_cont_wrt_typ_rec k A5 c)
  | (cont_inftapp A c) => cont_inftapp (open_typ_wrt_typ_rec k A5 A) (open_cont_wrt_typ_rec k A5 c)
  | (cont_sub A) => cont_sub (open_typ_wrt_typ_rec k A5 A)
end.
...
Definition open_cont_wrt_typ A5 c5 := open_cont_wrt_typ_rec 0 c5 A5.
...
Fixpoint close_cont_wrt_typ_rec (k:nat) (A5:var) (c5:cont) {struct c5}: cont :=
  match c5 with
  | (cont_infabs c) => cont_infabs (close_cont_wrt_typ_rec k A5 c)
  | (cont_infapp e c) => cont_infapp (close_exp_wrt_typ_rec k A5 e) (close_cont_wrt_typ_rec k A5 c)
  | (cont_inftapp A c) => cont_inftapp (close_typ_wrt_typ_rec k A5 A) (close_cont_wrt_typ_rec k A5 c)
  | (cont_sub A) => cont_sub (close_typ_wrt_typ_rec k A5 A)
end.
...
Definition close_cont_wrt_typ c5 A5 := close_cont_wrt_typ_rec 0 c5 A5.
...
Fixpoint subst_tvar_in_cont (A5:typ) (X5:typvar) (c5:cont) {struct c5} : cont :=
  match c5 with
  | (cont_infabs c) => cont_infabs (subst_tvar_in_cont A5 X5 c)
  | (cont_infapp e c) => cont_infapp (subst_tvar_in_exp A5 X5 e) (subst_tvar_in_cont A5 X5 c)
  | (cont_inftapp A c) => cont_inftapp (subst_tvar_in_typ A5 X5 A) (subst_tvar_in_cont A5 X5 c)
  | (cont_sub A) => cont_sub (subst_tvar_in_typ A5 X5 A)
end.
...
(** infrastructure *)
#[export] Hint Constructors s_in neq_abs neq_all neq_bot d_wf_typ d_wf_exp d_wf_body d_wf_env d_mono_typ d_wf_cont d_wf_work d_wf_wl d_sub a_evs_in_wl a_wf_typ a_mono_typ a_wf_exp a_wf_body a_wf_cont a_wf_work a_wf_wl lc_typ lc_exp lc_body lc_cont lc_abind lc_work lc_dbind lc_aworklist lc_dvalue lc_dworklist : core.
